...
namespace TranSimCS.Menus.InGame {
    public static class SelectionUtils {
        ...
        public static void AddAddLaneSelectors(Mesh mesh, InGameMenu game) => AddAddLaneSelectors(mesh, game.World.Nodes.data, ConnectionTool.GetActualLaneSpec(game).Width);
